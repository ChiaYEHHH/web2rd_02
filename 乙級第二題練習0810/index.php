...
<body>
	...
	<div id="all">
		<div id="title">
			<?= date("m 月 d 日 l")  ?> | 今日瀏覽: <?= $_SESSION['total']; ?> | 累積瀏覽: <?= q("select sum(`total`) as 'total' from `total`")[0]['total'];  ?>
			<a href="index.php" style="float: right;">回首頁</a>
		</div>
		<div id="title2">
			<a href="index.php"><img src="./images/02B01.jpg" title="健康促進網 - 回首頁" srcset=""></a>
		</div>
		<div id="mm">
				...
				<div>
					...
					<span style="width:18%; display:inline-block;">
						...
						if (isset($_SESSION['user'])) {
							...
							echo "<button type='button' onclick='location.href='./api/logout.php''>登出</button>";
						} else {
	...
	<a href="https://github.com/mackliu/11301-BQUIZ-02">乙級第2題</a>
</body>
