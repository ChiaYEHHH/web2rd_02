...
<body>
	...
	<div id="title">
		<?= date("m 月 d 號 l"); ?> | 今日瀏覽: <?= $Total->find(['date' => date("Y-m-d")])['total'] ?> | 累積瀏覽: <?= q("select sum(`total`) as `totalview` from `total`")[0]['totalview']; ?>
	...
	<div id="mm">
		...
		<div class="hal" id="main">
			<div>
				<marquee style="width:72%;">555555555555</marquee>
